...
if (isset($_POST['TenDT'])){ 
   ...
   $idLoai = $_POST['idLoai'];
   $qt->SP_Them($TenDT, $MoTa, $Gia, $GiaKM, $baiviet, $urlHinh, $AnHien, $Hot,  $NgayCapNhat, $idLoai);
            ...
            <div class="body">
                <form id="form_validation" method="POST">
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="text" class="form-control" name="TenDT" required maxlength="100" minlength="10"  placeholder="Tên Điện Thoại">                         
                        </div>
                    </div>
                    <div class="form-group form-float">
                        <div class="form-line">
                            <textarea name="MoTa" cols="30" rows="5" class="form-control no-resize" placeholder="Mô Tả"></textarea>                           
                        </div>
                    </div>
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="number" class="form-control" name="Gia" id="Gia" placeholder="Giá" >                           
                        </div>
                    </div>
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="number" class="form-control" id="KM" placeholder="% Giảm" min="0" style="width:200px; display:inline;"> %
                            <input type="number" class="form-control" id="GiaKM" name="GiaKM" style="width:600px; float:right;" placeholder="Giá Khuyến Mãi" value="" readonly>                            
                        </div>
                    </div>
                    <div class="form-group form-float"> 
                        <div class="form-line">
                            <input type="text" name="urlHinh" id="urlHinh" class="form-control" onclick="selectFileWithCKFinder('urlHinh')" placeholder="Địa chỉ hình của bài viết" >
                        </div> 
                    </div>
                    <div class="row cleafix">
                        ...
                        <div class="col-md-4">
                            <div class="form-group form-float">
                                <input type="radio" name="Hot" id="HOT0" value="0">
                                <label for="HOT0">Thường</label>
                                <input type="radio" name="Hot" id="HOT1" value="1" checked>
                    ...
                    <div class="row cleafix">                       
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" class="datepicker form-control" name="NgayCapNhat" placeholder="Ngày Đăng" style="width:500px;">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group form-float" style="clearfix:both;">
                        <div class="form-line">
                            <textarea name="baiviet" cols="30" rows="5" class="form-control no-resize" placeholder="Bài Viết"></textarea>                           
                        </div>
                    </div>                                                    
