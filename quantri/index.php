...
<body class="theme-red">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Quản Trị Bán Hàng</a>
            </div>
        </div>
    </nav>
    <!-- #Top Bar -->
    ...
    <section class="content">
        <?php 
        switch ($p){
            case "loai_sp": require "loai_sp.php"; break;
            case "loaisp_them": require "loaisp_them.php"; break;
            case "loaisp_sua": require "loaisp_sua.php"; break;
